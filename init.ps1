...
$sharedSkillInstaller = Join-Path $repoRoot 'install-repo-skills.ps1'
...
if (Test-Path $sharedSkillInstaller) {
  Write-Host 'Syncing shared repo skills...'
  & $sharedSkillInstaller
}
